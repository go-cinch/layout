...
func RegisterGameHTTPServer(s *http.Server, srv GameHTTPServer) {
	r := s.Route("/")
	r.POST("/game/create", _Game_CreateGame0_HTTP_Handler(srv))
	r.GET("/game/get", _Game_GetGame0_HTTP_Handler(srv))
	r.GET("/game/list", _Game_FindGame0_HTTP_Handler(srv))
	r.PATCH("/game/update", _Game_UpdateGame0_HTTP_Handler(srv))
	r.PUT("/game/update", _Game_UpdateGame1_HTTP_Handler(srv))
	r.DELETE("/game/delete", _Game_DeleteGame0_HTTP_Handler(srv))
}
