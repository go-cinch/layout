...
func (c *gameClient) DeleteGame(ctx context.Context, in *params.IdsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedGameServer) DeleteGame(context.Context, *params.IdsRequest) (*emptypb.Empty, error) {
...
func _Game_DeleteGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServer).DeleteGame(ctx, req.(*params.IdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
